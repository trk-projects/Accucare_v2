...
exports.handler = async (event) => {
  ...
  const { name, facility, email, phone, service, message, submitted_at, source_page } = JSON.parse(event.body || '{}');
        ...
        <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
          <tr>
            ...
            <td style="padding:12px 16px;background:#f8fafc;border-bottom:1px solid #e2e8f0;border-left:1px solid #e2e8f0;">
              <p style="margin:0;font-size:11px;color:#94a3b8;font-weight:600;text-transform:uppercase;letter-spacing:0.8px;">Facility</p>

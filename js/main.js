      ...
      <div class="lead-modal" id="lead-modal">
        <div class="lead-modal__header">
          <div class="lead-modal__header-text">
            ...
            <p>Fill out the form and our team will follow up within one business hour.</p>
          </div>
        ...
        <div class="lead-modal__body">
          ...
          <form class="lead-modal__form" id="lead-modal-form" novalidate>
            <div class="form__row">
              ...
              <div class="form__group">
                <label for="lm-facility">Facility / Organization <span class="form__required" aria-hidden="true">*</span></label>
                <input type="text" id="lm-facility" name="facility" class="form__input" placeholder="Houston Medical Center" required />
                <div class="form__error" aria-live="polite"></div>
              </div>
            </div>
            <div class="form__row">
              <div class="form__group">
                ...
                <input type="email" id="lm-email" name="email" class="form__input" placeholder="jane@facility.com" required autocomplete="email" />
                <div class="form__error" aria-live="polite"></div>
              </div>
              <div class="form__group">
